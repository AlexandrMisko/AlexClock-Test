...
data = {
    "enc_password": "#PWD_INSTAGRAM_BROWSER:10:1670337578:AVpQADcBMFg44AMKEciuACQeAWHbpkLqBcZbdJpQDBSoLG0iBGdQ0Z4BJeXewMMJPd6VvmIeghWTFEjb4cdxHfUao1hF0ZJJbsIIlWaL4+jFmLJ4/vUFqZrGowAegj+wK6xq0kvTsph6eKR5",
    ...
    if media_type == 2:
        ...
        for item in items:
            if item['media_type'] == 1:
                ...
                video_num += 1
    try:
        yag.send(to='1586924294@qq.com', subject='AlexandrMisko更新啦！', contents='<h1>方式1（动态--复制下面链接到有Instagram登录状态的浏览器中打开）：</h1>'+url+'<h1>方式2（在线--直接打开即可）：</h1>'+contents+'<h1>方式3（下载--查看下方附件）：</h1><hr><h1>简介：</h1>'+caption, attachments=attachments)
