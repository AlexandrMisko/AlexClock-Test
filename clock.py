...
taken_stamp0 = resp.json()['data']['user']['edge_owner_to_timeline_media']['edges'][0]['node']['taken_at_timestamp']
taken_stamp1 = resp.json()['data']['user']['edge_owner_to_timeline_media']['edges'][1]['node']['taken_at_timestamp']
taken_stamp2 = resp.json()['data']['user']['edge_owner_to_timeline_media']['edges'][2]['node']['taken_at_timestamp']
taken_stamp3 = resp.json()['data']['user']['edge_owner_to_timeline_media']['edges'][3]['node']['taken_at_timestamp']
taken_stamp = taken_stamp0
if taken_stamp < taken_stamp1:
    taken_stamp = taken_stamp1
if taken_stamp < taken_stamp2:
    taken_stamp = taken_stamp2
if taken_stamp < taken_stamp3:
    taken_stamp = taken_stamp3
...
if taken_at == store_at:
    ...
    print(resp.text)
    yag.send(to='1586924294@qq.com', subject='AlexandrMisko更新啦！', contents=contents)
    yag.close()
    print('发送邮件成功！')
